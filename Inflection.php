...
class Inflection
{
    ...
    public function __construct()
    {
        ...
        $this->vzor[$nvz++] = Array('m', 'leden', 'ledna', 'lednu', 'leden', 'ledne', 'lednu', 'lednem', 'ledny', 'lednů', 'lednům', 'ledny', 'ledny', 'lednech', 'ledny');
        $this->vzor[$nvz++] = Array('m', 'únor', 'února', 'únoru', 'únor', 'únore', 'únoru', 'únorem', 'únory', 'únorů', 'únorům', 'únory', 'únory', 'únorech', 'únory');
        $this->vzor[$nvz++] = Array('m', 'březen', 'března', 'březnu', 'březen', 'březne', 'březnu', 'březnem', 'březny', 'březnů', 'březnům', 'březny', 'březny', 'březnech', 'březny');
        $this->vzor[$nvz++] = Array('m', 'duben', 'dubna', 'dubnu', 'duben', 'dubne', 'dubnu', 'dubnem', 'dubny', 'dubnů', 'dubnům', 'dubny', 'dubny', 'dubnech', 'dubny');
        $this->vzor[$nvz++] = Array('m', 'květen', 'května', 'květnu', 'květen', 'květne', 'květnu', 'květnem', 'květny', 'květnů', 'květnům', 'květny', 'květny', 'květnech', 'květny');
        $this->vzor[$nvz++] = Array('m', 'červen', 'června', 'červnu', 'červen', 'červne', 'červnu', 'červnem', 'červny', 'červnů', 'červnům', 'červny', 'červny', 'červnech', 'červny');
        $this->vzor[$nvz++] = Array('m', 'srpen', 'srpna', 'srpnu', 'srpen', 'srpne', 'srpnu', 'srpnem', 'srpny', 'srpnů', 'srpnům', 'srpny', 'srpny', 'srpnech', 'srpny');
        $this->vzor[$nvz++] = Array('m', 'říjen', 'října', 'říjnu', 'říjen', 'říjne', 'říjnu', 'říjnem', 'říjny', 'říjnů', 'říjnům', 'říjny', 'říjny', 'říjnech', 'říjny');
